         ...
         <DialogContent className="sm:max-w-4xl p-0 overflow-hidden border-none rounded-[2rem] gap-0">
            {selectedProduct && (
                <div className="flex flex-col md:flex-row h-full max-h-[90vh] md:max-h-none overflow-y-auto md:overflow-hidden">
                    {/* Image Gallery */}
                    <div className="w-full md:w-3/5 bg-slate-950 relative group aspect-square md:aspect-auto">
                    ...
                    <div className="w-full md:w-2/5 p-8 flex flex-col bg-card">
                        ...
                        <div className="flex-1 space-y-6 overflow-y-auto pr-2 custom-scrollbar">
                           ...
                           {selectedProduct.warrantyMonths && (
                               <div className="p-4 bg-muted/50 rounded-2xl border border-border space-y-1">
                                   <div className="flex items-center gap-2 text-primary">
                                       <ShieldCheck className="w-4 h-4" />
                                       <span className="text-[10px] font-black uppercase tracking-widest">Garantía Asegurada</span>
                                   </div>
                                   <p className="text-sm font-black text-foreground">{selectedProduct.warrantyMonths} MESES DE COBERTURA</p>
                                   <p className="text-[9px] text-muted-foreground font-medium uppercase leading-tight">Certificado oficial en cada compra.</p>
                               </div>
                           )}
                        </div>
                        ...
                        <div className="pt-8 space-y-3">
                            ...
                            <button 
                                ...
                                className="w-full h-12 bg-muted hover:bg-muted/80 text-muted-foreground rounded-2xl flex items-center justify-center font-black uppercase text-[10px] tracking-widest transition-colors"
                            >
                                SEGUIR NAVEGANDO
                            </button>
                        </div>
